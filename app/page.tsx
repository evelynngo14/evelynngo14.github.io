  ...
  return (
    <>
      ...
      <div className="flex flex-col h-300 bg-blogBG text-blogText gap-5">
        ...
        i got good results using a grid layout with a fixed width and height for each cell using a absolute position.
        elements like the scroll bar and chevron arrows had to be manually positioned using top / right / bottom / left utilities.
